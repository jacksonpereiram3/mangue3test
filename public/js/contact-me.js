$(document).ready(function() {
    ...
    $("#contact-form [type='submit']").click(function(e) {
        ...
        $('#block-answer').html('<div id="answer" style="display: block;"><div class="success-message"><p><i class="fa fa-check-circle"></i> Olá ' + user_name + '. Sua mensagem foi enviada, nós retornaremos para você o mais rápido possível!</p></div></div>');
